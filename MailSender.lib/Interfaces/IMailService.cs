...
namespace MailSender.lib.Interfaces
{
    ...
    public interface IMailSender
    {
        ...
        Task SendAsync(string SenderAddress, IEnumerable<string> RecipientsAddress, string Subject, string Body,
            IProgress<(string Recipient, double Percent)> Progress = null, CancellationToken Cancel = default);

        Task SendParallelAsync(string SenderAddress, IEnumerable<string> RecipientsAddress, string Subject, string Body,
