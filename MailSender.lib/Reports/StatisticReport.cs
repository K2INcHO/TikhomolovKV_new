...
namespace MailSender.lib.Reports
{
    public class StatisticReport
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00F12208", RsidRunAdditionDefault = "001C52E9" };
            ...
            Run run1 = new Run() { RsidRunProperties = "003714BC" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "003714BC", RsidParagraphAddition = "003714BC", RsidRunAdditionDefault = "003714BC" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "003714BC", RsidParagraphAddition = "003714BC", RsidRunAdditionDefault = "003714BC" };
            ...
            paragraphMarkRunProperties3.Append(languages1);

            paragraphProperties3.Append(paragraphMarkRunProperties3);

            Run run2 = new Run() { RsidRunProperties = "003714BC" };
            ...
            Text text4 = new Text();
            text4.Text = SendedMailsCount.ToString();
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphMarkRevision = "001C52E9", RsidParagraphAddition = "003714BC", RsidRunAdditionDefault = "003714BC" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "001C52E9", RsidR = "003714BC" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "004B624E" };
            Rsid rsid1 = new Rsid() { Val = "0010691D" };
            Rsid rsid2 = new Rsid() { Val = "001C52E9" };
            Rsid rsid3 = new Rsid() { Val = "003714BC" };
            Rsid rsid4 = new Rsid() { Val = "004B624E" };
            Rsid rsid5 = new Rsid() { Val = "00D77990" };
            ...
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{5554E763-087E-4501-BC53-95C99986BD1A}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts9 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            ...
            runPropertiesBaseStyle1.Append(runFonts9);
            runPropertiesBaseStyle1.Append(fontSize4);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript4);
        ...
        {
            document.PackageProperties.Creator = "K2INcHO";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "3";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-10-19T06:37:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-10-19T06:40:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "K2INcHO";
        }
